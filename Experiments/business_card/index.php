...
if(!$row){
    echo "<script> alert('회원정보가 없습니다.index')</script>";
...
<div class="container">
    <div class="card card--front">
        ...
        <div class="text">
            <header class="head">
                <h1 class="head__name">
                    <b class="name__fn"><?php echo $row[email]?></b>
                    <?php echo $row[name]?>
                </h1>
                <p class="head__subtitle"> <?php echo $row[side]?><br><?php echo $row[job]?></p>
            </header>
        </div>
    </div>
    ...
    <div class="card card--back">
        <div class="card__content">
            <ul class="contact">
                <li><a href="https://keithpickering.github.io"><?php echo $row[blog_url]?></a></li>
                <li><a href="https://facebook.com/<?php echo $row[facebook_id]?>">facebook.com/<?php echo $row[facebook_id]?></a></li>
                <li><a href="https://twitter.com/<?php echo $row[twitter_id]?>">twitter.com/<?php echo $row[twitter_id]?></a></li>
                <li><a href="https://github.com/<?php echo $row[github_id]?>">github.com/<?php echo $row[github_id]?></a></li>
        </div>
    </div>
