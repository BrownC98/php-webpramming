...
<div class="login-page">
    <div class="form">
        <form class="register-form" method="post" action="signup.php">
            ...
            <input type="text" placeholder="job (ex, developer)" name="job"/>

            <input type="text" placeholder="blog url (ex, keithpickering.github.io)" name="blog_url"/>
            <input type="text" placeholder="facebook id" name=""/>
            <input type="text" placeholder="twitter id" name=""/>
            <input type="text" placeholder="github id" name=""/>
